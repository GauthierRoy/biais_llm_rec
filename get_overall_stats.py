...
def calculate_metrics_stats(data: dict) -> dict:
    ...
    stats = {
        "overall_mean_iou": round(calculate_average(iou_means), 3),
        "overall_mean_std_iou": round(calculate_average(iou_stds), 3),
        "overall_mean_serp": round(calculate_average(serp_means), 3),
        "overall_mean_std_serp": round(calculate_average(serp_stds), 3),
        "overall_mean_prag": round(calculate_average(prag_means), 3),
        "overall_mean_std_prag": round(calculate_average(prag_stds), 3),
        "overall_mean_diversity": round(calculate_average(diversity_means), 3),
        "overall_mean_std_diversity": round(calculate_average(diversity_stds), 3)
    }
...
if __name__ == "__main__":
    files_to_analyze = [
        "data/metric_results/gemma3_4b_college_student.json",
        "data/metric_results/gemma3_4b_music_music_fan.json",
        "data/metric_results/gemma3_4b_movie_movie_fan.json",
        "data/metric_results/llama3.2_3b_college_student.json",
        "data/metric_results/llama3.2_3b_music_music_fan.json",
        "data/metric_results/llama3.2_3b_movie_movie_fan.json",
        "data/metric_results/gemma3_1b_college_student.json",
        "data/metric_results/gemma3_1b_music_music_fan.json",
        "data/metric_results/gemma3_1b_movie_movie_fan.json",
        "data/metric_results/gemma3_12b_college_student.json",
        "data/metric_results/gemma3_12b_music_music_fan.json",
        "data/metric_results/gemma3_12b_movie_movie_fan.json",
        "data/metric_results/qwen3_4b_college_student.json",
        "data/metric_results/qwen3_4b_music_music_fan.json",
        "data/metric_results/qwen3_4b_movie_movie_fan.json",
        "data/metric_results/minicpm3_4b_college_student.json",
        "data/metric_results/minicpm3_4b_music_music_fan.json",
        "data/metric_results/minicpm3_4b_movie_movie_fan.json",
        "data/metric_results/smollm3_3b_college_student.json",
        "data/metric_results/smollm3_3b_music_music_fan.json",
        "data/metric_results/smollm3_3b_movie_movie_fan.json",
        "data/metric_results/llama3.2_1b_college_student.json",
        "data/metric_results/llama3.2_1b_music_music_fan.json",
        "data/metric_results/llama3.2_1b_movie_movie_fan.json",
        "data/metric_results/qwen3_1.7b_college_student.json",
        "data/metric_results/qwen3_1.7b_music_music_fan.json",
        "data/metric_results/qwen3_1.7b_movie_movie_fan.json",
        "data/metric_results/qwen3_14b_college_student.json",
        "data/metric_results/qwen3_14b_music_music_fan.json",
        "data/metric_results/qwen3_14b_movie_movie_fan.json",
    ]
